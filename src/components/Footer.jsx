...
export default function Footer() {
  ...
  // Extract category sections for footer links
  const newsLinks = navigationConfig.find((n) => n.id === "news")?.children || [];
  const reviewLinks = navigationConfig.find((n) => n.id === "reviews")?.children || [];
  const guideLinks = navigationConfig.find((n) => n.id === "guides")?.children || [];
